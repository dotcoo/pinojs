...
import rich_person_last_names_data from './rich/person_last_names_data.json';
import rich_person_first_names_male_data from './rich/person_first_names_male_data.json';
import rich_person_first_names_female_data from './rich/person_first_names_female_data.json';

const person_last_names_data = import.meta.env.MODE == 'rich' ? rich_person_last_names_data : {
...
const person_first_names_male_data = import.meta.env.MODE == 'rich' ? rich_person_first_names_male_data : {
...
const person_first_names_female_data = import.meta.env.MODE == 'rich' ? rich_person_first_names_female_data : {
...
function phone() {
  return `1${this.random([3, 5, 8])}${this.int(100000000, 999999999)}`;
}
...
function install(pino) {
  ...
  // data
  d.person_last_names_data = person_last_names_data;
  d.person_last_names = person_last_names;
  d.person_first_names_male_data = person_first_names_male_data;
  d.person_first_names_male = person_first_names_male;
  d.person_first_names_female_data = person_first_names_female_data;
  d.person_first_names_female = person_first_names_female;
  d.person_first_names_data = person_first_names_data;
  d.person_first_names = person_first_names;
  d.person_jobs = person_jobs;

  // methods
  o.name_update = m(name_update);
  o.last_name = m(last_name);
  o.last_name_pinyin = m(last_name_pinyin);
  o.first_name_male = m(first_name_male);
  o.first_name_male_pinyin = m(first_name_male_pinyin);
  o.first_name_female = m(first_name_female);
  o.first_name_female_pinyin = m(first_name_female_pinyin);
  o.first_name = m(first_name);
  o.first_name_pinyin = m(first_name_pinyin);
  o.name = m(name);
  o.name_male = m(name_male);
  o.name_female = m(name_female);
  o.name_pinyin = m(name_pinyin);
  o.gender = m(gender);
