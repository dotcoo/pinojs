...
function install(pino) {
  ...
  // data
  d.company_names_data = company_names_data;
  d.company_names = company_names;
  d.company_types = company_types;
  d.company_suffixes = company_suffixes;

  // methods
  o.company_name = m(company_name);
  o.company_name_pinyin = m(company_name_pinyin);
  o.company_type = m(company_type);
  o.company_suffix = m(company_suffix);
  o.company = m(company);
  o.company_short = m(company_short);
}
